...
import {IDepositAddress, IUserData, IWallet, IWalletAddress, IWithdraw} from "../user/user.type";
...
export class WalletService {
  ...
  approveWithdrawById(withdrawalId: number): Observable<IWithdraw[]> {
    const headers = new HttpHeaders()
      .set('Bypass-Tunnel-Reminder', 'anything');
    return this.http.post<IWithdraw[]>(`${environment.apiUrl}wallet/withdraw/approve`, {withdrawalId},{ headers: headers });
  }
